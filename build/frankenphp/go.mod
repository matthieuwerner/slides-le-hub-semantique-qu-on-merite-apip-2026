module github.com/matthieuwerner/slides-le-hub-semantique-qu-on-merite-apip-2026/build/frankenphp

go 1.26.0

// Local paths, so the binary is always built from the extension in this working tree rather
// than from a published version of it.
replace (
	github.com/matthieuwerner/slides-le-hub-semantique-qu-on-merite-apip-2026/go => ../../go
	github.com/matthieuwerner/slides-le-hub-semantique-qu-on-merite-apip-2026/go/ext => ../../go/ext
)

require (
	github.com/caddyserver/caddy/v2 v2.11.4
	github.com/dunglas/frankenphp/caddy v1.12.7
	github.com/matthieuwerner/slides-le-hub-semantique-qu-on-merite-apip-2026/go/ext v0.0.0
)
...
require (
	...
	github.com/matthieuwerner/slides-le-hub-semantique-qu-on-merite-apip-2026/go v0.0.0 // indirect
